      ...
      <div className="min-h-[calc(100vh-200px)] flex flex-col items-center justify-center py-16 px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="mb-12 text-center reveal-element">
            ...
            <h1 className="text-2xl md:text-3xl font-semibold text-text-primary mb-2">Welcome back</h1>
            <p className="text-text-tertiary text-base">Sign in to continue to your workspace</p>
          </div>
          ...
          <div className="mt-8 text-center">
            ...
            Don't have an account?{' '}
              <Link to="/sign-up" className="text-text-primary font-semibold hover:text-primary-400 transition-colors duration-micro ease-apple inline-flex items-center gap-1 group">
              Sign up
